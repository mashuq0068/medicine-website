  ...
  const features = [
    {
      ...
      title: "১০০% প্রাকৃতিক",
      description:
        "কোনো রাসায়নিক উপাদান নেই, সম্পূর্ণ প্রাকৃতিক হার্বাল ফর্মুলা",
    },
    {
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Dr. Reckeweg এর বিশেষ ফর্মুলেশন - প্রতিটি স্বাস্থ্য সমস্যার জন্য
              প্রাকৃতিক সমাধান
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                হোমিওপ্যাথি কেন{" "}
                <span className="text-medical-green">কার্যকর?</span>
              </h2>
              <p className="text-lg text-muted-foreground mb-8">
                প্রাকৃতিক উপাদান থেকে তৈরি, শরীরের নিজস্ব প্রতিরোধ ক্ষমতা বৃদ্ধি
                করে রোগ নিরাময় করে। কোনো পার্শ্বপ্রতিক্রিয়া ছাড়াই
                দীর্ঘমেয়াদী সুস্বাস্থ্য নিশ্চিত করে।
              </p>
      ...
      <section className="py-8 bg-medical-green text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
            আজই শুরু করুন আপনার স্বাস্থ্যকর জীবনযাত্রা। বিশ্বস্ত জার্মান
            হোমিওপ্যাথিক ওষুধের সাথে থাকুন নিরাপদ।
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
